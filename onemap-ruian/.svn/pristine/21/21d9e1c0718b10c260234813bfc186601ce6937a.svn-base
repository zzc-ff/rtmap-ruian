...
import com.rtmap.common.utils.Query;
import com.rtmap.modules.sys.dao.SysUserDao;
import com.rtmap.modules.sys.entity.SysUserEntity;
import com.rtmap.modules.sys.service.SysRoleService;
...
/*		IPage<SysUserEntity> page = this.page(
		...
		List<SysUserEntity> list = this.baseMapper.selectUserList(page,username,createUserId);
	...
	public void saveUser(SysUserEntity user) {
		...
		//保存用户与项目的关系
		sysUserMarketService.saveOrUpdate(user.getUserId(), user.getMarketIdList());
